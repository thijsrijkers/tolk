...
const userStatus = {
  ...
  const usernameLabel = (<HTMLInputElement>document.getElementById("username-label"));
  const usernameDiv = (<HTMLInputElement>document.getElementById("username-div"));
  const usersDiv = (<HTMLInputElement>document.getElementById("users"));
